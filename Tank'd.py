...
#                         self.__init__()
    ...
    def run_logic(self, screen,pointsGained):
        ...
        if not constants.game_over:
            ...
            if constants.activeMode != 2 and pygame.time.get_ticks()%2 == 0:
...
#             pygame.draw.polygon(screen,colors.RED,[[100,constants.menu_height/2],[100,constants.menu_height/4]],2)
    ...
    def instruction(self,screen,background):
        ...
        bigFont = pygame.font.SysFont("Arial", 34)
        ...
        instructions10 = font.render('Hard Mode Only:',True,colors.BLACK)
        ...
        instructions15 = font.render('Medium Mode:',True,colors.BLACK)
        instructions16 = font.render('1. twice as many enemies as easy mode',True,colors.GREEN_BLACK)
...
def main():
    ...
    bigfont = pygame.font.SysFont("Arial", 25)
    ...
    while not done:
        ...
        if pygame.time.get_ticks()/1000 > secInt:
            ...
            scoreText = bigfont.render('score  ' + str(constants.score),True,colors.GREEN)
            gameTimeText = bigfont.render('time  ' + str((pygame.time.get_ticks()-constants.pauseTimeSinceStart-constants.lastEndTime)/1000),True,colors.GREEN)
            highScoreText = bigfont.render('high  ' + str(constants.highScore),True,colors.GREEN)
...
#                 screen.blit(fattyHealth, [thisFatty.rect.x+16.5,thisFatty.rect.y+13])
            ...
            pygame.display.update(0,0,constants.screen_width,50)

...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Tank'd.py"
 
        #Name of program
        self.project_name = "Tank'd"
        ...
        #Auhor of program
        self.author_name = "Nick Ackerman"
        self.author_email = "nckackerman@gmail.com"
        self.copyright = "Copyright (c) 2016 Me."
 
        #Description
        self.project_description = "Geometry wars clone made in python"

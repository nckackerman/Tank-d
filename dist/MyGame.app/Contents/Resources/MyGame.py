...
#                         self.__init__()
    ...
    def spawn_enemies(self):
        ...
        elif (pygame.time.get_ticks()-constants.lastEndTime-constants.pauseTimeSinceStart)/100 == 60:
        ...
        #if (self.gameTime/1000)%5 == 0 and (math.floor(self.gameTime/1000)) != self.triggerTime:
        if deltaSeconds >= constants.timeTillSpawn or len(Lists.Enemy_list) < constants.minEnemyCount:
            ...
            self.triggerTime = math.floor(self.gameTime/1000)
